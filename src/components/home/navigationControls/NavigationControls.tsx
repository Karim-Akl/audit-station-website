...
import { AiOutlineArrowUp, AiOutlinePhone, AiOutlineWhatsApp } from 'react-icons/ai';
  ...
  return (
    ...
    transition-shadow delay-75 ease-in-out hover:opacity-30'
      ...
      transition-transform  transform duration-300 ease-out ${
        showIcons ? 'translate-y-0 opacity-100 scale-100' : 'translate-y-5 opacity-0 scale-90'
      }`}
          >
