...
import Logo1 from "@../../../public/assets/img-3.png";
    ...
    <div className="swiper-2 w-full">
        <div className=" background-color relative h-[calc(100vh-50px)] text-white overflow-hidden   ">
          <div className="flex  justify-between m-auto  items-center h-full ">
            ...
            <div className="mt-5 relative hidden lg:block  top-36  mr-4  ">
        <div className="flex  justify-center items-center text-center rounded-full w-full  h-full relative m-auto">


            <div className="flex bg-green-400  overflow-hidden  z-30  justify-center items-center text-center rounded-full  h-60 w-60 absolute -top-[100%] left-[-120%] m-auto">
              <Image
                src={Logo2}
                alt="logo"
                loading="lazy"
                className=" z-30 object-contain w-[80%] "
              />
              </div>
          
            <div className="flex bg-yellow-400 overflow-hidden z-30   justify-center items-center text-center rounded-full  h-60 w-60 relative m-auto ">
              <Image
                src={Logo3}
                alt="logo"
                loading="lazy"
                className=" z-30 object-cover w-[80%] h-auto  "
              />
              </div>
              <div className="flex bg-blue-400 overflow-hidden z-30   justify-center items-center text-center rounded-full  h-60 w-60 absolute -top-[150%] -left-[10%] m-auto">
              <Image
                src={Logo3}
                alt="logo"
                loading="lazy"
              ...
              <Image
                ...
                alt="logo"
                loading="lazy"
                className="absolute bottom-10 -left-96  -rotate-180  "
              />
              </div>
