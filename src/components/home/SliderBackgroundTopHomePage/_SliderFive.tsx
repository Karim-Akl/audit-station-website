        ...
        <div className='flex  justify-between m-auto items-center h-full'>
          <div className='p-20 my-10 flex flex-col gap-4 max-w-lg md:max-w-2xl '>
            ...
            <p className='text-[#22B9DD] text-md'>
              At Audit Station, our experts work on your tax reports with great precision and
              accuracy, which will ensure no errors or mistakes in them, saving you from the hassle
              and save your business from having any financial risks or issues with the authorities.
            </p>
