...
{/* component Not notifications 
      <div className="flex  flex-col shadow-xl w-[50%] m-auto justify-center items-center">
          <div>
            <Image src="/assets/Group.png" className="" alt="logo" width={200} height={200} />
          </div>
          <div className="flex items-center justify-center rounded-b-2xl bg-[#22B9DD] w-full  mt-5">
            <h2 className="text-[#fff] py-10">No new notifications at the moment.</h2>
          </div>
      </div> */}
    </div>
  );
